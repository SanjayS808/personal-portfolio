...
import ssa from "/public/ssa.png";
        ...
        <div className="flex justify-center  p-10 font-black text-4xl">
          ...
          <div id= "card" className="flex justify-center px-10 ">
            ...
            <div class="card-inner">
                ...
                <Image src={ssa} className="rounded-lg" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
                <div class="card-back">
                    <ul className="p-5">

                      <li className=" text-xl font-bold "> <a href = "https://ssa-hub-test-jqlwn0eo4qfflknni.herokuapp.com/accounts/sign_in"><span class="border-b border-solid border-black border-b-3">SSA Community Hub</span></a></li>
                      <li className="py text-sm font-bold "> Ruby on Rails, JavaScript </li>
                      <li className=" text-sm p-2"><p>• Commissioned by the Saudi Students Association to create a community hub that connected over 300+ students.</p></li>
                      <li className=" text-sm p-2"><p>• Enhanced student engagement by providing a centralized platform for event RSVPs, updates, and content sharing.</p></li>
                      <li className=" text-sm p-2"><p>• Developed the application using Ruby on Rails, PostgreSQL, and JavaScript for a seamless user experience.</p></li>
            ...
            <div class="card-inner">
                ...
                <div class="card-back">
                    <ul className="p-5">
                      ...
                      <li className="py text-sm font-bold "> React, Node, Python, SQL</li>
